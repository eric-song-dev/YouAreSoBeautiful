// =============================================================================
// beauty-dive-progress · 深潜进度桌宠（Client 半 · 永久插件）
...
`
    var CSS_TAG = 'dsh-beauty-dive-progress/styles.css'
    if (typeof document !== 'undefined' && document.querySelector('style[data-plugin-css=' + JSON.stringify(CSS_TAG) + ']') === null) {
      var tag = document.createElement('style')
      tag.dataset.plugin = 'dsh-beauty-dive-progress'
    ...
    var SPRITE_PATH = '/beauty-dive/spritesheet.webp'
